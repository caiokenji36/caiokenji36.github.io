      ...
      <div class="container">
	    ...
	    <div class="container">
	    	...
	    	<div class="col-md-4">
	    		...
	    		<br />
	    		<br />
				<form method="post" action="edita_con.php" id="formCadastrarse">
					<div class="form-group">
						
						<input type="text" class="form-control" id="usuarioo" name="usuarioo" placeholder="<?= ucfirst($_SESSION['usuario'])?>" required="requiored">
						<?php
					...
					<div class="form-group">
						<input type="text" class="form-control" id="nomee" name="nomee" placeholder="<?=$_SESSION['nome']?>" required="requiored">
					...
					<div class="form-group">
						<input type="email" class="form-control" id="emaill" name="emaill" placeholder="<?= $_SESSION['email']?>" required="requiored">
					...
					<div class="form-group">
						<input type="text" class="form-control" id="telefone" name="telefone" placeholder="<?=$_SESSION['telefone']?>" required="requiored">
				...
				<!-- Navbar 	<div class="form-group">
						<input type="date" class="form-control" id="data" name="data" placeholder="AAAA/MM/DD"  required="requiored">
					...
					<div class="form-group ">
						...
						<input type="password" class="form-control" id="senhaa" name="senhaa" placeholder="Senha" required="requiored" onkeyup="senhaForca()"></div>
