...
<script type="text/javascript">
 ...
 var dropDown = $('.ul-secundario'); //classe do submenu que vai abrir  
    ...
    botao.on('click', function(event){
	 ...
	 <script type="text/javascript">
	 $(document).ready(function() {
 var botao = $('.aaaa'); //classe no a
 var dropDown = $('.ul-secundario2'); //classe do submenu que vai abrir  
...
<!-- comeco do hodape -->
	...
	<nav class="nav-testt">
		<ul id="ul-principal">
			...
			<li class="li-p">
				<a class="aaaa" href="javascript://">Ranking
					<img src="imagens/seta1.png" width="12px">
				</a>
				<ul class="ul-secundario2">
					<li class="li-s"><a class="aa" href="ranking_geral.php">Ranking Geral</a></li>
					<li class="li-s"><a class="aa" href="ranking_precos.php">Ranking Preços</a></li>
					<li class="li-s"><a class="aa" href="ranking_atendimento.php">Ranking Atendimento</a></li>
