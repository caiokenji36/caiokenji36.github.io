...
<html lang="pt-br">
<head>
	<title>Cadastre-se | Usuário</title>
...
<body>
    ...
    <nav class="conteiner cadastro">
      ...
      <div class="page-header">
        <p>CADASTRE-SE PARA ENCONTRAR OS MELHORES BARES!</p>
      </div>

      <!-- ENTRADA DO LOGIN -->
      <div class="row">
        <form method="post" class="form-group" action="valida_dados_usuario.php">  
          ...
          <div class="form-group">
            <div class="col-sm-8 col-md-offset-2">
              ...
              <label>
              	<!-- MENSAGEM CASO JÁ EXISTA ALGUM E-MAIL CADASTRADO -->
                <?php
                  if ($erro_email) {
          ...
          </div><!-- // FIM DA ENTRADA DO E-MAIL -->
          <!-- ENTRADA DO NOME DO USUÁRIO -->
          <div class="form-group">
            <div class="col-sm-8 col-md-offset-2">
              <label class="texto"><b>Insira o seu nome*</b></label>
