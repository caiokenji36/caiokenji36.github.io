		...
		<div class="container theme-showcase" role="main">
			...
			<div class="row">
				<?php while($rows_bar = mysqli_fetch_assoc($resultado_bar)){ 
								$id = $rows_bar['idBar'];
								$cont = "SELECT bar.nome as nome,
								avGeral as avaliacoes,
								bar.idBar as bar,
								bar.endereco as endereco,
								SUM(avGeral) as SOMA_TOTAL,
								COUNT(bar.idBar)  as TOTAL_NOTA,
								(SUM(avGeral)/COUNT(bar.idBar)) as MEDIA
								FROM avaliacao, bar
								WHERE 
								bar.idBar = avaliacao.idBar
								GROUP BY bar.idBar
								ORDER BY MEDIA DESC 
								LIMIT 3";
					...
					<div class="col-sm-6 col-md-6">
						<div class="thumbnail">
							...
							<a href="verBar.php?id_bar=<?php echo $rows_bar['idBar'];?>"><img width="600px" height= "10px" src="imagensBar/123.jpg" > </a>
							
							<div class="caption text-center">
							
						
							
								<h3><?php echo $rows_cont['nome']; ?></h3>
								<h3><?php echo $rows_cont['endereco']; ?></h3>
								<p><?php echo $abre; ?></p>
								<div class="col-md-1"><h4><?php echo $rows_cont['MEDIA']; ?></h4></div>
								<div class="col-sm-1"><img src="imagensBar/estrela.png" width="30px" height="30px" alt="..."></div>
								<div class="col-md-1" id=""> <h4><?php echo "(".$rows_cont['SOMA_TOTAL'].")"; ?></h4></div>
